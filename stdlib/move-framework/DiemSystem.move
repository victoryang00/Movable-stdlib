...
module DiemSystem {
    ...
    /// An out of bounds indexfor the validator set was encountered
    ...
    /// Get the indexof the validator by address in the `validators` vector
    ...
    spec fun get_validator_index_ {
        ...
        /// If `addr` is in validator set, return the least indexof an entry with that address.
