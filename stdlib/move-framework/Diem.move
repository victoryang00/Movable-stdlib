...
module Diem {
    ...
    struct CurrencyInfo<CoinType> has key {
        ...
        /// e.g.for "XDX" this isx"584458".No character limit.
        currency_code: vector<u8>,
    ...
    /// `amount`, the `Preburn` resource with with the smallest indexin this
    ...
    acquires CurrencyInfo {
        letxdx_exchange_rate =xdx_exchange_rate<FromCoinType>();
    ...
    spec schema ApproxXdmForValueAbortsIf<CoinType> {
        from_value: num;
        include AbortsIfNoCurrency<CoinType>;
        letxdx_exchange_rate = spec_xdx_exchange_rate<CoinType>();
