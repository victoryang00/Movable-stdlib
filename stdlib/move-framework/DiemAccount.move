...
module DiemAccount {
    ...
    /// Maxvalid tier indexis 3 since there are max4 tiers per DD.
    ...
    /// Construct an authentication key, aborting if the prefixis not valid.
    ...
    spec fun create_authentication_key {
        ...
        /// key prefixof a specific length.
        pragma opaque;
    ...
    fun prologue_common<Token: store>(
        ...
        // [PCA5]: Check that the maxtransaction fee does not overflow a u64 value.
        assert(
